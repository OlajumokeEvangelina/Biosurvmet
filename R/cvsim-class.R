#' The cvsim Class.
#'
#' Class of object returned by function \code{\link[Biosurvmet]{CVSim}}.
#'
#' @name cvsim-class
#' @rdname cvsim-class
#' @exportClass cvsim
...
setMethod("summary",signature="cvsim", function(object){
  ...
  cat("Estimated Median of the cross Validated HR for Top K metabolites \n")
